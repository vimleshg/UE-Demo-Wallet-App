...
public class Cab extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        try {
            UserExperior.setCustomTag("Cab", UeCustomType.EVENT);
        } catch (Exception e) {
            e.printStackTrace();
        }

        Toast.makeText(this, "Cab Feature coming soon....", Toast.LENGTH_SHORT).show();

        try {
            UserExperior.setCustomTag("Cab Feature coming soon....", UeCustomType.MSG);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
